...
from farnsworth.models import ChallengeSetFielding, IDSRuleFielding, Exploit, PovFuzzer2Job, Test, PovTestResult
...
try:
    ...
    if not pov_fuzzer.exploitable() and pov_fuzzer.dumpable():
